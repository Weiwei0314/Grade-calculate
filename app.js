...
// parameter1 control target
// parameter2 animation duration
// parameter3 primitive condition of the target
// parameter4 the condition of the target after the animation
// parameter5 to acclerate the animation cut in time
time_line
...
// enter key is forbidded in the whole page
...
//prevent the trash button to submit
...
//while changing the credits, the GPA would be re-calculated
...
function setGPA() {
  ...
  document.getElementById("result-gpa").innerHTML = result;
}
...
addButton.addEventListener("click", () => {
  ...
  //create 5 elements corespond to the html
...
//adding remove here to prevent immediately remove the form
allTrash.forEach((trash) => {
...
function handleSorting(direction) {
  ...
  for (let i = 0; i < graders.length; i++) {
    //graders[i].children returns HTML collection
  ...
  //after getting object array , convert String to Number
  ...
  //update the whole site according to the objectArray
  ...
  //select cannot be changed by the upper for loop , change it by selecting it
